...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("<div class='sidebar-title'>⭐ Saved Players</div>", unsafe_allow_html=True)
    ...
    with st.container():
        ...
        with col_search:
            query = st.text_input("Search player (autocomplete)", value="", placeholder="Type at least 2 letters…")
    ...
    with st.spinner("Pulling recent games and building models…"):
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("<div class='luxe-card'>", unsafe_allow_html=True)
    st.markdown("## 🔮 Core Line (Next Game)")
    ...
    # ------------------ Full stat table ------------------------
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("### 📊 Full Predicted Stat Line")
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("### 🎲 Monte Carlo Distribution Explorer")
